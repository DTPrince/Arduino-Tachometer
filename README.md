...
There are still many weird things I could blab on about but instead I'll attempt to finish with the strange characteristics. The duty cycle of this wave appears to be closer to 1/3 than 1/2 -- which the FreqMeasure lib warns against. Though I'd rather have an undersquare duty cycle than an oversquare, honestly.(I really want to talk about potato canons now. I had such a good idea earlier. Yay compressed air!) That is not the only strange thing though, some of the waves have these strange artefacts where they'll be split along regular lines. If you scroll up to the last picture it'll be very obvious. The interesting thing is that they are very regular and almost identical in period regardless of the larger square wave that they are mixed in with.
